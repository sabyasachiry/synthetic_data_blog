...
* Scalability: A limited access to data restricts organisation's ability to train ML/AI models with higher accuracy at scale. Lack of access to relevant data also limits organisational readiness in leveraging advanced technologies such as Machine Learning and AI to scale business operations. Synthetic data solves this problem by making it cheaper to acquire data or share data without privacy concerns. 
...
Technological solutions can also be employed to help mitigate privacy concerns. Organizations can share noised, fully or partially simulated, or encrypted datasets internally or externally without much concern. Where data can not be released, the code with full end-to-end realisation of their pipeline can be shared with external parties for reproducibility - a practice often used in research and medical practices.
