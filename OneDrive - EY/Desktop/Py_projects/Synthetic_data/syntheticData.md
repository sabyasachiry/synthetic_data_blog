...
**In the absence of real-world data:** Synthetic data can be generated to imitate scenarios that have never been seen before (e.g. in Reinforcement Learning). The data would be equally accessible to everyone, regardless of the size of business – and retaining integrity.
