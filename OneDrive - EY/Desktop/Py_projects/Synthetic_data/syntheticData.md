...
The accuracy and performance matrices generated by Machine Learning models depend on the statistical relationship between input data. Methods used for data aggregation cooupled with random noise in data can distort such relationship between variables in the dataset[2]. This can impact on reproducibility of results
...
[2] Purdam, K. and Elliot, M., 2007. A case study of the impact of statistical disclosure control on data quality in the individual UK Samples of Anonymised Records. Environment and Planning A, 39(5), pp.1101-1118.