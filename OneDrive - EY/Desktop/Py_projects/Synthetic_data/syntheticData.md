...
For example several machine learning algorithms are used in design and implementation of Intrusion Detection Systems(IDS) to identify and produce timely response to attacks on computer networks. The algorithms typically aim to predict users' behaviour on system using multiclass classification and/or clustering to identify unusual behavioural patterns from the normal ones in advance. 
